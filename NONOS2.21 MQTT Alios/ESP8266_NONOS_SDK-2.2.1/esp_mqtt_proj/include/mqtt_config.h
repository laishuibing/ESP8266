...
#define MQTT_HOST            "a1mk7vPluBw.iot-as-mqtt.cn-shanghai.aliyuncs.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
...
#define MQTT_USER            "smartLight&a1mk7vPluBw" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "" // you MQTT login password, same as above
#define STA_SSID "Guan"    // your AP/router SSID to config your device networking
#define STA_PASS "iwant246" // your AP/router password
